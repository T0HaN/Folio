...
from app.routers import auth, characters, master, player, websockets, dashboard
...
# === CORS ===
# Список разрешённых источников берётся из настроек (переменная CORS_ORIGINS, через запятую)
