...
from app.models import AmmoUseRequest, SpellCreate
from app.dependencies import get_current_user, templates, get_room_service, get_spell_service, get_combat_service, get_character_service, require_room_access
...
async def player_room(
    ...
    if is_spellcaster:
        ...
        _, known_spells, _ = spell_service.get_spells_for_class(char_class, char.get('level', 1), known_spells_names)
