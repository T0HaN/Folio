// static/js/pages/character.js
// Логика для страницы просмотра персонажа: броски кубиков, токен
...
async function uploadToken(event) {
    ...
    reader.onload = async (e) => {
        ...
        try {
            const response = await fetch(`/char/${window.CHAR_ID}/token/upload`, {
                method: 'POST',
            ...
            if (result.status === 'ok') {
                ...
                preview.classList.add('has-token');
